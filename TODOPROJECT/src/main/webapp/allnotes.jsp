...
<html lang="en">
  ...
  <img class=" class-img-top m-4  mx-auto"src="notepad.png" style=" max-width:100px;"class="card-img-top" alt="...">
  <div class="card-body px-5">
    <h6 class="card-title text-warning">(<%=n.getId()%>)</h6>
    <h3 class="card-title text-dark"><%=n.getTitle()%></h3>
    <p class="card-text text-success"><%=n.getContent()%></p>
    <p ><b class="text-danger"><%=n.getAdded_Date()%></b></p>
    <div class="container text-center">
    <a href="deleteservlet?list_id=<%=n.getId()%>" class="btn btn-danger">Delete</a>
    <a href="edit.jsp?list_id=<%=n.getId() %>" class="btn btn-primary">Edit</a></div>
  </div>
</div>
